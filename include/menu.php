    ...
    <div class="row">
      <div class="col-lg-12">
        <nav class="navbar navbar-expand-lg">
          <a class="navbar-brand" href="/tino">
          ...
          <div class="navbar-collapse">
            <ul id="nav" class="navbar-nav mx-auto">
              <li class="nav-item">
                <a class="" href="index.php"><?php echo $lang['menu1']; ?>
                  <!-- Comment ça marche? --->
                </a>
              </li>

              <li class="nav-item">
                <a class="" href=""><?php echo $lang['menu2']; ?>
                  <!-- Aide --->
                </a>
              </li>

              <li class="nav-item">
                <a class="" href="contact.php"><?php echo $lang['menu3']; ?>
                  <!-- Contact --->
                </a>
              </li>
          ...
          if (isset($_SESSION['connect'])) {
            ...
            <div class="navbar-btn d-none d-sm-inline-block">
              <a href="connexion.php" class="ud-main-btn ud-login-btn"><?php echo $lang['menu4']; ?>
                <!-- Connexion -->
              </a>
              <a class="ud-main-btn ud-white-btn" href="sign-up.php"><?php echo $lang['menu5']; ?>
                <!--  S'inscrire -->
              </a>
            </div>
